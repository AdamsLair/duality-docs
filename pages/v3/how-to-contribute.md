...
The most important tools of the trade are [Duality itself](https://adamslair.github.io/duality), the [Forum](https://github.com/AdamsLair/duality/discussions), [Chat](https://discord.com/invite/ZgnhPzr), or any other means you're personally using to publish things on the internet, say [Twitter](https://twitter.com/search?f=tweets&vertical=default&q=%23duality2d%20lang%3Aen%20-RT), a dev blog or similar. Let's see what you can do:
